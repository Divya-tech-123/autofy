...
export default function HeroVisual() {
  return (
    <div className="relative w-full max-w-[620px] mx-auto select-none">
      ...
      <motion.div
        className="absolute -right-4 bottom-12 animate-float-card3 z-10"
        initial={{ opacity: 0, x: 30 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.6, delay: 1.1 }}
      >
        <div className="card-glass rounded-2xl px-4 py-3 shadow-xl border border-white/80">
          <div className="text-xs text-slate-500 mb-1 font-medium">Client Satisfaction</div>
          <div className="flex items-baseline gap-1">
            <span className="text-2xl font-bold font-display text-slate-900">100</span>
